# SAP HANA Virtual Schema

Using this adapter you can integrate data from [SAP HANA](https://www.sap.com/products/hana.html) into the Exasol database, so that you can access them in your analytics just like a regular table.
